...
public class TicketSummaryGenerator(IReadOnlyList<Product> products, IReadOnlyList<TicketThread> threads, IServiceProvider services) : SimpleGeneratorBase<TicketThread>(services)
{
